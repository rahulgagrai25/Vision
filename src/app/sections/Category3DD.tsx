// ./src/app/sections/Category3DD.tsx
'use client'
...
function Category3() {
  ...
  // const totalCategories = categories.length; // Removed unused variable
  ...
  return (
    <div className="font-['Roboto'] relative overflow-x-hidden">
      <div className="min-h-screen w-full py-12 px-6 bg-white relative">
        ...
        >
          ...
          {/* Grid Layout - Desktop view on all screens */}
              ...
              return (
                ...
                >
                  <Image // Used Next.js Image component
                    src={category.src}
                    alt={category.alt}
                    width={isCenter(index) ? 256 : 192} // w-64 (256px) or w-48 (192px)
                    height={isCenter(index) ? 256 : 192} // h-64 (256px) or h-48 (192px)
